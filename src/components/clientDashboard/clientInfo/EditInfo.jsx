  ...
  const getAllUserCompanyInfo = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_APP_URL}/api/v1/contact/getAllCompanyInfo`
      );
  ...
  return (
    <div className="editInfoContainer">
      <div className="adminDashboard">
        <div className="admin-desktop-sidebar sideMenuContainer">
          <ClientSideMenu />
        </div>
        <div className="client-mobile-wrapper">
          <ClientMobileMenu />
        </div>

        <div className="container client-dash-wrapper ">
          <h3 className="mobile-client-heading">Company Information</h3>
          <div className="editInfo client-table-wrapper">
