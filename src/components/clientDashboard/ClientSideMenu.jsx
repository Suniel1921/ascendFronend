    ...
    <>
      <div className="sideMenu">
        ...
        <div className="clientDataContainer">
          <img
            className="clientImg"
            src="https://img.freepik.com/free-photo/cheerful-indian-businessman-smiling-closeup-portrait-jobs-career-campaign_53876-129417.jpg?t=st=1722753642~exp=1722757242~hmac=4fe2973764b69c9412056b03c5204957c9abfb3dc062f259dfa5cb07afed926d&w=740"
            alt=""
          />
        ...
        <div className="dropdownContainer">
          ...
          <div
            className={`dropdownContent ${dropdowns.ecommerce ? "open" : ""}`}
          >
        ...
        <div className="dropdownContainer">
          ...
          <div
            className={`dropdownContent ${dropdowns.category ? "open" : ""}`}
          >
