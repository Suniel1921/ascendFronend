        ...
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            <Route path="/" element={<Layout />}>
              ...
              <Route
                path="/Corporation_VS_LLC"
                element={<Corporation_VS_LLC />}
              />
              <Route
                path="/benefits-of-incorporating"
                element={<Benefits_of_Incorporating />}
              />
              <Route
                path="/Incorporation_101"
                element={<Incorporation_101 />}
              />
              <Route
                path="/industry-specific-information"
                element={<Industry_specific_information />}
              />
              <Route path="/tax-filings" element={<Tax_filings />} />
              <Route path="/learning-center" element={<Learningcenter />} />
              <Route
                path="/Business_Comparision_Chart"
                element={<ComparisionChart />}
              />
              <Route
                path="/How_To_Incorporate"
                element={<How_To_Incorporate />}
              />
              <Route
                path="/Business_Glossary"
                element={<Business_Glossary />}
              />
              <Route
                path="/Protecting_Your_Investment"
                element={<Protecting_Your_Investment />}
              />
              <Route path="/Our_Services" element={<Our_Services />} />
              <Route
                path="/Benefits_of_Delaware_LLC"
                element={<Benefits_of_Delaware_LLC />}
              />
              <Route
                path="/How_To_Start_a_Franchise_10_Steps"
                element={<How_To_Start_a_Franchise_10_Steps />}
              />
              <Route
                path="/Staying_Compliant"
                element={<Staying_Compliant />}
              />
              <Route
                path="/Federal_Requirements"
                element={<Federal_Requirements />}
              />
              <Route
                path="/Top_10_Business_Mistakes"
                element={<Top_10_Business_Mistakes />}
              />
              <Route
                path="/Writing_A_Business_Plan"
                element={<Writing_A_Business_Plan />}
              />
              <Route
                path="/Business_Compliance_Guide"
                element={<Business_Compliance_Guide />}
              />
              <Route
                path="/10_Steps_to_Form_A_Business"
                element={<Steps_to_Form_A_Business />}
              />
              <Route path="/state-guides" element={<State_Guides />} />
              ...
              <Route
                path="/Learning_Center/California"
                element={<California />}
              />
              <Route path="/Learning_Center/Colorado" element={<Colorado />} />
              <Route
                path="/Learning_Center/Connecticut"
                element={<Connecticut />}
              />
              <Route path="/Learning_Center/Delaware" element={<Delaware />} />
              <Route
                path="/Learning_Center/District_of_Columbia"
                element={<District_of_Columbia />}
              />
              ...
              />
              <Route
                path="/Learning_Center/New_Mexico"
                element={<New_Mexico />}
              />
              <Route path="/Learning_Center/New_York" element={<New_York />} />
              <Route
                path="/Learning_Center/North_Carolina"
                element={<North_Carolina />}
              />
              <Route
                path="/Learning_Center/North_Dakota"
                element={<North_Dakota />}
              />
              ...
              <Route
                path="/Learning_Center/Pennsylvania"
                element={<Pennsylvania />}
              />
              <Route
                path="/Learning_Center/Rhode_Island"
                element={<Rhode_Island />}
              />
              <Route
                path="/Learning_Center/South_Carolina"
                element={<South_Carolina />}
              />
              <Route
                path="/Learning_Center/South_Dakota"
                element={<South_Dakota />}
              />
              <Route
                path="/Learning_Center/Tennessee"
                element={<Tennessee />}
              />
              ...
              <Route
                path="/Learning_Center/Washington"
                element={<Washington />}
              />
              <Route
                path="/Learning_Center/West_Virginia"
                element={<West_Virginia />}
              />
              <Route
                path="/Learning_Center/Wisconsin"
                element={<Wisconsin />}
              />
              ...
              <Route
                path="/Business_Entity_Types"
                element={<Business_Entity_Types />}
              />
              <Route
                path="/registered-agent-service"
              ...
              />
              <Route
                path="/Professional_Corporation"
                element={<Professional_Corporation />}
              />
              <Route path="/Series_LLC" element={<Series_LLC />} />
              <Route
                path="/Limited_Partnership"
                element={<Limited_Partnership />}
              />
              <Route
                path="/starting-a-business"
                element={<Starting_A_Business />}
              />
              <Route path="/Name_Reservation" element={<Name_Reservation />} />
              <Route
                path="/business-licenses"
                element={<Business_Lisences />}
              />

              {/* Maintaining a business navbar */}
              <Route path="/scrop-election" element={<Scrop_Election />} />
              ...
              />
              <Route
                path="/by-laws-operating-agreements"
                element={<By_Laws_operating_Agreements />}
              />
              <Route
                path="/certificate-of-good-standing"
                element={<Certificate_of_Good_Standing />}
              />
              <Route
                path="/dba-business-name"
                element={<DBA_Business_Name />}
              />
              <Route
                path="/llc-tax-status-election"
                element={<LLC_Tax_Status_Election />}
              />
              <Route path="/Make_a_Payment" element={<Make_a_Payment />} />
              <Route
                path="/maintaining-a-business"
                element={<Maintaining_a_Business />}
              />
              <Route
                path="/nonprofit-501-status"
                element={<NonProfit_501_Status />}
              />
              <Route
                path="/register-in-additional-states"
                element={<Register_in_Additional_States />}
              />
              <Route path="/CSC_Navigator" element={<CSC_Navigator />} />
              <Route
                path="/Corporate_and_LLC_Kits"
                element={<Corporate_and_LLC_Kits />}
              />
              <Route path="/Certified_Copies" element={<Certified_Copies />} />
              <Route
                path="/Stock_And_Membership"
                element={<Stock_And_Membership />}
              />
              <Route path="/Written_Consent" element={<Written_Constent />} />
              <Route path="/scrop-election" element={<Scrop_Election />} />
              <Route
                path="/Delaware_E_Filing"
                element={<Delaware_E_Filing />}
              />
              <Route path="/Amendments" element={<Amendments />} />
              <Route
                path="/Entity_Conversion"
                element={<Entity_Conversion />}
              />
              <Route path="/Dissolution" element={<Dissolution />} />
              <Route path="/Reinstatement" element={<Reinstatement />} />
              <Route
                path="/Mail_Forwarding_Service"
                element={<Mail_Forwarding_Service />}
              />

              {/* Download guide */}
              <Route
                path="/download-guide-info"
                element={<DownloadGuideInfo />}
              />
