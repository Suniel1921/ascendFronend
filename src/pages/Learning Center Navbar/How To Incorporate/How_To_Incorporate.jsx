...
import "./How_To_Incorporate.css";

const How_To_Incorporate = () => {
  return (
    <div className='how-to-incorporate-container'> 
      <h2 className="how-to-incorporate-heading">
      How to Incorporate or Form an LLC
      </h2>
      <div className="how-to-incorporate-bottom-container">
        <div className="how-to-incorporate-left-container">
          <div className='how-to-incorporate-content'>
            <p>
            Ascend makes it easy for you to form a corporation or Limited Liability Company (LLC) in any state. Most small business owners decide to incorporate to protect personal assets, gain credibility, and save on taxes.
            </p>

            <h3>How Do I Incorporate?</h3>
            ...
            <ul>
              ...
              <li>We complete Articles of Incorporation (for a corporation) or Articles of Organization (for an LLC) on your behalf. A few states require us to get your signature on the completed documents before submission. Normally, we submit documents directly to the state.</li>
...
export default How_To_Incorporate;