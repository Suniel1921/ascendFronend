...
const Incorporation101 = () => {
  return (
    <div className="incorporation_container">
      <h1 className="incorporation_heading">Incorporation 101: How to Incorporate a Small Business</h1>

      <div className="incorporation_main">
        <div className="incorporation_left">
          <h2 className="incorporation_subheading">Do I need to incorporate my small business?
          </h2>
          ...
          <ul className="incorporation_list">
            <li><b>Personal asset protection.</b>Both corporations and LLCs allow owners to separate and protect their personal assets. In a properly structured and managed company, owners should have limited liability for business debts and obligations.</li>
            <li><b>Additional credibility.</b> Adding "Inc." or "LLC" after your business name adds instant authority and legitimacy. Consumers, vendors, and partners may prefer to do business with an incorporated company.</li>
            <li><b>Nationwide availability.</b> All 50 states and the District of Columbia now recognize both corporations and LLCs.</li>
            <li><b>Name protection.</b>  In most states, other businesses may not file your exact corporate or LLC name in the same state.</li>
            <li><b>Perpetual existence.</b> Corporations and LLCs exist perpetually, even if their ownership or management changes. Sole proprietorships and partnerships end if an owner dies or leaves the business.</li>
            <li><b>Tax flexibility. </b> Though profit and loss typically pass through an LLC and get reported on the personal income tax returns of owners, an LLC can also elect to be taxed as a corporation. Likewise, a corporation can avoid double taxation of corporate profits and dividends by electing Subchapter S tax status.</li>
            <li><b>Deductible expenses. </b>  Both corporations and LLCs may deduct normal business expenses–such as salaries–before they allocate income to owners.</li>
          </ul>

          <h2 className="incorporation_subheading">Importance of incorporating to protect your assets</h2>
          <p className="incorporation_paragraph">
          ...
          <ol className='incorporation_list'>
            <li><b>Decide to incorporate.</b>Before you set up a corporation, it's important to understand the benefits of incorporating or forming an LLC. Knowing just what incorporating entails for you as a business owner–including financial and administrative expectations that may need to be reported periodically–can help you decide if incorporating is the right move for your company.</li>
            <li><b>Select Ascend</b>It's simple to form a corporation through Ascend. Rather than sift through endless piles of complicated paperwork and confusing terminology, you can rely on our experts, who have helped countless businesses through the process of incorporation. Our thorough understanding of incorporation practices nationwide will make the process of forming a corporation a painless experience. Learn why we think you will benefit from our services.</li>
            <li><b>Choose a business structure. </b>You may be wondering, "Exactly how do I incorporate my business?" We'll help guide you through the process, including the different business structures–C corps, S corps, and LLCs–and all their different benefits, which may help you choose the best structure for your company's current needs and anything that arises in the future. Check out our Business Comparison Chart for more info.</li>
            <li><b>Choose a state. </b>Once you've decided to start your own corporation, depending upon your company's needs, you may want to incorporate in a state other than where your business currently functions. Additionally, some states have strict guidelines around unique names for corporations. When registering your corporation, you can rely on our experts to help you name your company following state guidelines. Get more information about choosing a state in which to start a corporation.
            </li>
            <li><b>Choose a package.</b>Once you have a firm grasp of the options that various company structures and states provide when forming or setting up a corporation, you're well on your way to carving out a well-planned future for your new business. View our package options and begin incorporating a business online today.
            </li>
            <li><b>Place your order. </b>You can Ascend or form an LLC online, or by phone with a business specialist at 98000000.
            </li>
          </ol>
          ...
          <ul className='incorporation_list'>
            <li>Apply for an employer identification number (EIN). Get help with your EIN application.</li>
            <li>Obtain business licenses and permits. For help, order our Business License Compliance Package.</li>
            <li>We file your documents with the state in which you wish to start a corporation or an LLC.</li>
