...
const Top_main = () => {
  useEffect(() => {
    ...
    const handleMouseMove = (event) => {
      ...
      const bottomRightImage = document.querySelector(
      ...
      if (customCursor) {
        customCursor.style.transform = `translate(${cursorX + offsetX}px, ${
          cursorY + offsetY
        }px)`;
      }
        ...
        <div className="main_background">
          <div className="main_background_left">
            ...
            <p className="main_paragraph">
              Ready to form an LLC, Corporation, or Non-Profit? At Ascend, we
              provide everything you need to start and maintain your business.
            </p>
