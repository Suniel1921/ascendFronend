...
const Business_Entity_Types = () => {
  return (
    <div className="business-entity-types-container">
      <h2 className="business-entity-types-heading">Business Entity Types</h2>
      <div className="business-entity-types-bottom-container">
        <div className="business-entity-types-left-container">
          <div className="business-entity-types-content">
            <p>
              To get the most out of your small business, choose the right
              structure. Selecting the right type of company or corporation for
              your new business helps maximize your chances of financial and
              operational success.
            </p>

            <p>
              Common types of business structures and corporations include C
              corporations, limited liability companies (LLC), partnerships, S
              corporations, and sole proprietorships. Learn more about each type
              of business or corporation:
            </p>
            ...
            <ul>
              ...
              <li>Must hold annual meetings and record meeting minutes.</li>
              <Link to="/s-corporation">Read more about S Corporations...</Link>
            </ul>
            ...
            <p>
              Review our{" "}
              <Link to="/Business_Comparision_Chart">
                Business Comparision Chart
              </Link>{" "}
              for more details. Regardless of business structure you choose,
              Ascend can help you incorporate or form an LLC online or by phone
              for less than the cost of using an attorney.
            </p>
          </div>
        </div>
        <div className="business-entity-types-right-container">
          <h3 className="business-entity-types-right-h3">
            Let's Ascend Incoperate
          </h3>
          <p>Create your corporation or limited liability company today.</p>
          <button className="business-entity-types-button-full">
            Get Started
          </button>
        </div>
      </div>
